...
// ERC20 and ERC223 have overlapping functions
interface ERC20 {
...
- ERC223 Token Standard has a fallback for transfers errors
- Without the fallback, tokens will be lost and won't be able to get back
